...
<div style="display: none;">
    <div id="quick{{ product.id }}" class="quick-content js-product-container">
                        ...
                        <div class="descriptioncolContent">
                                ...
                                <div class="span5 price-holder">
                                    <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                        <div class="price {% if not product.display_price%}hidden{% endif %}">
                                            ...
                                            <span class="offer-product js-offer-label"{% if not product.compare_at_price or not product.display_price %}style="display:none;"{% endif %}>
                                                <span>
                                                    <span class="js-offer-percentage">{{ price_discount_percentage |round }}</span>% OFF
                                                </span>
                                            </span>
											</span>
                                            <span class="price" id="price_display" itemprop="price" content="{{ product.price / 100 }}" {% if not product.display_price %}class="hidden"{% endif %}>
                            ...
                            <form id="product_form" method="post" action="{{ store.cart_url }}">
                                ...
                                <div class="addToCartButton">
                                    ...
                                    <input type="submit" class="js-prod-submit-form button addToCart {{state}}" value="{{ texts[state] | translate }}" />
                                </div>
                            </form>
