        ...
        <div class="page-account container page">
            ...
            <div class="row">
                <div class="details-box col-md-4 col-sm-4 col-xs-12">
                    ...
                    {% if order.address %}
                        <div class="st"><strong>{{'Envío' | translate}}:</strong> {{ (order.shipping_status == 'unfulfilled'? 'No enviado' : 'Enviado') | translate }}</div>
                ...
                <div class="order-box col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="order-actions">
                        {% if order.pending %}
                            <a class="btn-lg agregar iniciar_compra" href="{{ order.checkout_url | add_param('ref', 'orders_details') }}" target="_blank">{{ 'Realizar el pago >' | translate }}</a>
                        {% endif %}
                    </div>
                </div>
            </div>
