<div class="row-fluid">
    <div class="container" id="banner-services">
        ...
        {% for banner in ['banner_services_01', 'banner_services_02', 'banner_services_03'] %}
            ...
            {% set has_banner_services =  banner_services_title or banner_services_description %}
            {% if has_banner_services %}
                <div class="col-md-{% if num_banners_services == 1 %}12{% elseif num_banners_services == 2 %}6{% elseif num_banners_services == 3 %}4{% endif %} col-sm-{% if num_banners_services == 1 %}12{% elseif num_banners_services == 2 %}6{% elseif num_banners_services == 3 %}4{% endif %} text-center col-xs-12">
