...
#ls_cart_widget .cart-summary, .button, .submit_button, #newsletter input.btn, #newsletter-popup input.btn.news, #calculate-shipping-button, .button.continue-buying, .submit_button.contact, .contact_form .submit_button, .contact_form .field input.submit_button, .password-password .btn {
    background-color: {{ settings.nav_cart }};
    background: {{ settings.nav_cart }};
    color: {{ settings.button_color}};
    font-family:{{ settings.font_buttons }};
}
...
.dest-gral .bajada .title a, .dest-gral .bajada .price, .dest-gral .bajada .price-compare span{
    font-family: {{ settings.font_product_title | raw }}!important;
}
...
#filters-column .color-filter, #filters-column .size-filter, #filters-column .other-filter { border: 1px solid {{ settings.text_color }}; }
