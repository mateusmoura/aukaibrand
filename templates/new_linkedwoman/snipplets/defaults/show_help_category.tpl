                        ...
                        <div class="dest-gral">
                            ...
                            <div class="bajada">
                                ...
                                <div class="price">
                                    ...
                                    <span class="price" id="price_display" itemprop="price" content="{{ product.price / 100 }}">{{"32000" | money }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="dest-gral">
                            ...
                            <div class="bajada">
                                ...
                                <div class="price">
                                    ...
                                    <span class="price" id="price_display" itemprop="price" content="{{ product.price / 100 }}">{{"122000" | money }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
