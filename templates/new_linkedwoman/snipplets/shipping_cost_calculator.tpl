...
<div class="shipping-calculator">
    <div class="shipping-calculator-form" {% if shipping_calculator_variant and not shipping_calculator_variant.available %}style="display: none;" {% endif %}>
	    ...
	    <input type="text" name="zipcode" class="shipping-zipcode" value="{{ cart.shipping_zipcode }}">
	    ...
	    <span class="invalid-zipcode" style="display: none;">{{ "El código postal es inválido." | translate }}</span>
	</div>
