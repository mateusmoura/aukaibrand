<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="order-box span8" id="orderDetailsDesk">
            ...
            <div class="sst ssb oh text-right">
                {% if order.pending %}
                    <a href="{{ order.checkout_url | add_param('ref', 'orders_details') }}" target="_blank">{{ 'Realizar el pago >' | translate }}</a>
                {% endif %}
            </div>
        </div>
        <div class="order-detail" id="orderDetailsMobile">
                 {% for item in order.items %}
                    <div class="order-box col-md-8 col-sm-8 col-xs-12 dos">
                        <div class="wrapper">
