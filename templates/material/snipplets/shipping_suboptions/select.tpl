...
<div class="shipping-suboption {{suboptions.name}}" {% if not selected_option %}style="display:none;"{% endif %}>
    {% if suboptions.options %}
        <select class="{% if selected_option and suboptions.required %}required{% endif %} form-control select" name="{{suboptions.name}}">
