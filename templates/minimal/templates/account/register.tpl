    ...
    <div class="account-form-wrapper">
        <form id="login-form" action="" method="post" class="form-horizontal">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="col-md-10">
                        <input class="form-control" type="password" name="password" id="password" placeholder="{{ 'Contraseña' | translate }}" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-10">
                        <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" placeholder="{{ 'Confirmar Contraseña' | translate }}" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-10">
